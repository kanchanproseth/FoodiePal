...
import com.cs473.mda.foodiepal.dashboard.dialog.AddRecipeInterface
...
class RecipeFragment : Fragment(R.layout.fragment_recipe), FragmentPropertyInterface, AddRecipeInterface {
    override val title = "Recipe"

    private var _binding: FragmentRecipeBinding? = null
    private val binding get() = _binding!!

    // RecyclerView
    private val adapter = RecipeRecyclerViewAdapter(arrayListOf())
    ...
    private fun viewBinding() {
        ...
        val addButton = binding.recipeAddButton
...
//        adapter.notifyDataSetChanged()
    ...
    private fun mockRecipe(): Recipe {
        ...
        return Recipe("Our Best Breakfast Casseroles", ingredients, instructions);
    }
